...
import { CurrencyAmount, PULSE, Percent, Trade } from './entities'
...
export abstract class Router {
  ...
  public static swapCallParameters(trade: Trade, options: TradeOptions | TradeOptionsDeadline): SwapParameters {
    const pulseIn = trade.inputAmount.currency === PULSE
    const pulseOut = trade.outputAmount.currency === PULSE
    // the router does not support both pulse in and out
    invariant(!(pulseIn && pulseOut), 'PULSE_IN_OUT')
